            ...
            <div className="container-section9 Hreveal">
                <div className="c9-containermain">
                    ...
                    <div className="c9-containerdireitos">
                        ...
                        <div className="c9-direitoright">
                            <a /* href="" */ rel="noopener noreferrer" target="__blank">Termos de Serviço</a>
                            <a /* href="" */ rel="noopener noreferrer" target="__blank">Política de Privacidade</a>
                        </div>
                    </div>
                </div>
            </div>
