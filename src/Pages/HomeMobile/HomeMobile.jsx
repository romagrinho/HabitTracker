...
export default function HomeMobile() {
    ...
    return (
        <section className="HomeCel">
            ...
            <div id="planilha-financeira" className="container-section4Cel">
                    ...
                    <div className="c4-containerrightCel">
                        <div className="c4-textconteinerCel">
                            ...
                            <div className="c4-buttonCel Hreveal4">
                                ...
                                <span className="c4-spanprice2Cel"><span className="c4-spanprice_green2">2x de R$ 13,89</span> ou R$24,90 à vista</span>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="c5-containerrightCel Hreveal">
                        ...
                        <div className="beneficiosCel">
                            ...
                            <div className="bene_leftCel">
                                ...
                                <span className="span-easyto">Easy to use & Design minimalista</span>
                            </div>
                        </div>
                        <div className="beneficiosCel">
                            <div className="bene_mainCel">
